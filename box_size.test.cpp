...
TESTCASE(box_size_fit_to_2d_wide_target)
{
	...
	auto const result = source_box.fit_to_2d(target_box);

	printf("%.8g %.8g\n", result[0], result[1]);
}

TESTCASE(box_size_fit_to_2d_tall_target)
{
...
TESTCASE(box_size_fit_to_2d_small_target)
{
